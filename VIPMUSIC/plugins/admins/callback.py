...
async def unban_assistant(_, callback: CallbackQuery):
    ...
    try:
        ...
        await callback.answer("𝑈𝑛𝑏𝑎𝑛 𝑃𝑎𝑛𝑛𝑖𝑦𝑎𝑐ℎ𝑢 𝐷𝑒𝑖 𝐴𝑑𝑚𝑖𝑛𝑢𝑢 𝑁𝑎𝑙𝑙𝑎 𝑖𝑟𝑢𝑝𝑎 𝑝𝑜𝑑𝑎 🥹🤌🏻\n\n𝑆𝑜𝑛𝑔 𝑃𝑜𝑑𝑢𝑑𝑎 𝑃𝑎𝑛𝑛𝑖 𝑀𝑢𝑛𝑗𝑢 𝑉𝑎𝑎𝑖𝑦𝑎 🚶\n\n𝑁𝑎𝑛𝑟𝑖𝑔𝑎𝑙 𝑃𝑎𝑙𝑎💝", show_alert=True)
    except Exception as e:
        await callback.answer(f"𝑈𝑛𝑏𝑎𝑛 𝑃𝑎𝑛𝑛𝑢𝑑𝑎 𝑀𝑎𝑛𝑔𝑎\n\n𝐵𝑎𝑛 𝑃𝑒𝑟𝑚𝑖𝑠𝑠𝑖𝑜𝑛 𝐾𝑢𝑑𝑢𝑛𝑔𝑎 𝑑𝑎 𝐴𝑑𝑚𝑖𝑛𝑢𝑢𝑢 🤌🏻✨ 𝑒𝑛 𝑝𝑎𝑛𝑔𝑎𝑙𝑖𝑦𝑎 𝑁𝑎𝑛𝑒𝑎 𝑈𝑛𝑎𝑏𝑎𝑛 𝑃𝑎𝑛𝑛𝑖𝑘𝑎𝑟𝑒𝑎𝑛 🥹🫀", show_alert=True)
...
async def markup_timer():
    ...
    for chat_id in active_chats:
        try:
            ...
            print(f"Error in markup_timer for chat {chat_id}: {e}")
            continue
